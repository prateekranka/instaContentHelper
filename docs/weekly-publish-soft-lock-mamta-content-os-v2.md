# Weekly Publish and Soft-Lock Contract: Mamta Content OS V2

This slice implements the Prateek/Admin publish contract while preserving fixture runtime by default.

## Product Contract

Prateek can publish the current weekly plan from Weekly Control.
...
- updates Mamta Today to the best matching published card
...
- returns the matching Mamta Today card
...
- `MamtaContentOSTests/PublishWeekFixtureAcceptanceTests.swift`
...
- Mamta Today reads the published fixture card
...
- load Mamta Today from cache before network refresh
