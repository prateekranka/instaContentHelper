# Reference Watchlist Import Implementation Spec: Creator Content OS V2
...
Build this for Manager/Admin Mode only.
...
- `CreatorContentOS/App/AppServices.swift`
...
- `CreatorContentOS/Models/Models.swift`
  - Add import/review models.
- `CreatorContentOS/Features/Intelligence/IntelligenceHomeView.swift`
...
- `CreatorContentOS/Features/Intelligence/ReferenceImportView.swift`
- `CreatorContentOS/Features/Intelligence/ReferenceImportPreviewView.swift`
- `CreatorContentOS/Features/Intelligence/ReferenceReviewEditSheet.swift`
- `CreatorContentOS/Features/Intelligence/BenchmarkCreatorsView.swift`
- `CreatorContentOS/Data/ReferenceImportDTOs.swift`
- `CreatorContentOS/Data/ReferenceImportRepository.swift`
...
2. Switch to Manager/Admin Mode.
3. Open Intelligence.
...
14. Creator Mode remains unchanged.
...
- No Creator-facing behavior should change.
