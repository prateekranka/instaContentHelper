# Local Supabase and Docker Setup: Mamta Content OS V2
...
```text
/Users/prateekranka/.colima/default/docker.sock
```

Mounting that path caused:

```text
error while creating mount source path '/Users/prateekranka/.colima/default/docker.sock':
...
6. verified:
   ...
   - `2026-06-05` Mamta Today card exists and is published
