# Layers Surface: Mamta Content OS V2 Full Intelligence MVP
...
- Previous reduced-MVP surface inventory: `docs/layers-surface-mamta-content-os-v2-mvp.md`
...
- Prove the daily Mamta loop first.
...
Mamta should still see a calm, minimal product:
...
Mamta should not see the full intelligence machinery by default.

### Prateek/Admin Mode

Prateek needs the full operating surface:
...
- Show the current Published Daily Card and let Mamta act.
...
- Pattern pages should foreground `Mamta adaptation`, not the external creator.
...
- Trend freshness should be visible, but not more prominent than Mamta fit.

### 11. Audio Options

Primary user: Prateek. Secondary: Mamta in Today audio section.
...
Primary user: Prateek and Mamta.
...
- `This may not fit Mamta. The style looks hard to shoot, off-voice, or too trend-led. Save for later or dismiss.`

Copying warning:

- `Use the structure, not the script. This Pattern should be adapted to Mamta's real day.`

Audio uncertainty:

- `This audio has not been verified on Mamta's account. Check in Instagram before posting or use the fallback.`
...
- Pattern: reusable structure + Mamta adaptation + source references.
...
- `Publish` only for making the Weekly Plan visible to Mamta.
...
4. Mamta's surface must remain insulated from admin complexity.
...
The design can support this, but implementation should still proceed in vertical slices. The first slice should prove that one Reference can become one approved Pattern/Trend/Audio Option, which can feed one Weekly Plan, which publishes one Daily Card Mamta can use.
