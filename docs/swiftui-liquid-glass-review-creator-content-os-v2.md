# SwiftUI Liquid Glass Review: Creator Content OS V2
...
- The earlier, denser Creator/Weekly/Intelligence boards are superseded and should not drive Liquid Glass placement or content density decisions.
...
Liquid Glass should make navigation and commands feel native to iOS 26. It should not make Creator's Daily Card, scripts, captions, Reference summaries, or Archive history translucent.
...
- Creator Mode bottom tabs: Today, Week, Archive, Settings.
...
- Settings/control icon in Creator Today.
...
- Creator needs calm certainty. Glass here makes the core content feel less grounded and harder to read.
...
- Creator primary actions: oxblood fill inside or adjacent to glass command bar.
