...
6. Open Daily to generate content one day at a time when the week is not
   ...
   - Review the returned storyboard and caption. Generated cards remain under
     Generated days after navigation or relaunch.
7. Stay in Daily to review and publish the selected date:
   - Inspect the selected card. Expand Full generated card to check
   ...
   - Generate that date again when its card is weak.
   - Tap Publish selected day only when that date is ready.
   - Verify that Today shows the card when the published date is today.
8. Open References.
...
10. Before generating a day, capture its location, workout or race schedule,
    family, travel, brand obligations, and any no-go topics in the day brief.
