# Layers Surface: Mamta Content OS V2 First TestFlight MVP
...
- Interaction flows: `docs/layers-interaction-flow-mamta-content-os-v2.md`
...
- Mamta should feel prepared, not managed.
- Prateek should feel in control of the weekly system, not buried in a SaaS dashboard.
...
- Mamta can use one Daily Card each morning.
- Prateek can prepare and publish a week.
- Prateek can add a small number of References and use them in generation.
- Mamta can decide, copy, request an alternative, and complete the day.
...
Surface fix: use softer Mamta-facing labels where the model term is too internal, while preserving the model underneath.

- Model term: Daily Card. Mamta-facing label: `Today`.
- Model term: Package Detail. Mamta-facing labels: `Scenes`, `Script`, `Caption`, `Audio`, `Post`.
- Model term: Card Alternative. Mamta-facing label: `Option`.
- Model term: Feedback. Mamta-facing label: `Tell us what to adjust`.
...
- Helper: `Enter the code Prateek created for this workspace.`
- Success: `This phone is paired as Mamta.`
...
- Mamta immediately knows what to shoot today and how hard it will be.
...
- If no card: `No card has been published for today. Ask Prateek to publish this week.`
...
- Use first-person labels for Mamta-facing completion actions where they feel natural.
...
- Prateek sees what needs to be prepared next and whether Mamta already has a published week.
...
- Prateek can enter enough context to generate a useful week.
...
- Prateek can trust and approve the 7 days before Mamta sees them.
...
- Prateek edits and approves exactly what Mamta will see.
...
- "Mamta preview" should be the default view. Advanced fields can be secondary.

### Trend + Inspiration Inbox MVP

Primary user need:

- Prateek can add and confirm raw source material.
...
- Prateek and Mamta can see what happened during the week without analytics pressure.
...
- Week published: show "Published to Mamta" and sync status.
...
- `No card has been published for today. Ask Prateek to publish this week.`
...
- `This audio may not be available on Mamta's account. Check it in Instagram before posting.`
...
- Mamta role: Today as home, Archive and Settings secondary.
- Prateek role: Setup as home, Today preview, References, Archive, Profile.

Surface decision:

- Do not use the same tab bar for Mamta and Prateek if it makes Mamta see admin machinery. Role-based home is acceptable for TestFlight.
...
5. Brand approval needs split. MVP recommendation: one simple `Approval needed` field in Brand Brief; separate Prateek vs brand approval later.

## Surface Decisions To Make Now

Priority 1:

- Final MVP navigation for Mamta vs Prateek roles.
...
- How "Published to Mamta" and sync status appear after publish.
...
- The Today surface has a clear primary job and should be the first screen Mamta sees.
