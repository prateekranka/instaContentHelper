# Local Notifications - Mamta Content OS V2

Section 6 schedules a gentle local notification from Mamta's synced Today card.

## Behavior

- Mamta's phone schedules the notification locally.
...
- Mamta records any final decision for Today.
