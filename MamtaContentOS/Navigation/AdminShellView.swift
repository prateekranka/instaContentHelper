...
struct AIRunwayView: View {
    ...
    var body: some View {
        EditorialScreen {
            ...
            GlassCommandBar {
                SecondaryActionButton(title: "Mamta mode") {
...
struct LiveQAView: View {
    ...
    private var todayBlock: some View {
        VStack(alignment: .leading, spacing: MCOSpace.s) {
            WeeklySectionTitle(title: "Mamta Today Card", subtitle: services.todayCard.context)
            JournalBlock {
                VStack(alignment: .leading, spacing: MCOSpace.m) {
        ...
        VStack(alignment: .leading, spacing: MCOSpace.s) {
            ...
            VStack(alignment: .leading, spacing: MCOSpace.xs) {
                Text("Testers")
                    .font(MCOType.display)
                    .foregroundStyle(MCOTheme.Color.ink)
                Text("Approve email OTP access for people testing Mamta's live workspace.")
                    .font(MCOType.body)
                    .foregroundStyle(MCOTheme.Color.inkMuted)
                    .fixedSize(horizontal: false, vertical: true)
            }
