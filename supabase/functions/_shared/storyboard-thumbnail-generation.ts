...
/** Live Gemini p50 needs one wave for five rows; five lanes is the production default. */
export const DEFAULT_STORYBOARD_THUMBNAIL_CONCURRENCY = 5;
const MAX_STORYBOARD_THUMBNAIL_CONCURRENCY = 5;
