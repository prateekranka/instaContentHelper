...
export function storyboardRowsForCard(
  ...
  const shotTimeline = recordArray(postInstructions.shot_timeline);
  const voiceoverTimeline = recordArray(postInstructions.voiceover_timeline);
  const onScreenTextTimeline = recordArray(
