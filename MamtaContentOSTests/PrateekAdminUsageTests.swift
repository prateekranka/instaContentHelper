...
@MainActor
final class PrateekAdminUsageTests: XCTestCase {
    func testPrateekSelectsIdeaForNextOpenDay() async throws {
    ...
    func testPrateekSeesErrorWhenIdeaSelectionFails() async throws {
        let weeklyRepository = RecordingWeeklyPlanRepository(
    ...
    func testPrateekReferenceImportPreviewAndConfirmRefreshesIntelligence() async throws {
    ...
    func testPrateekReviewsNeedsYourCallItemAndHomeRefreshes() async throws {
