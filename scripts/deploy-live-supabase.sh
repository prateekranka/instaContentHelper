...
FUNCTIONS="exchange-auth-session pair-device revoke-device-session send-auth-email manage-testers publish-week read-content write-content import-references review-reference generate-week generate-plan-ideas generate-storyboard-thumbnail generate-storyboard-thumbnails make-day-available unpublish-day update-ready-day-package runtime-health"
